 ...
 */
@Entity
@Table(name = "tipo_docu", catalog = "regivisitas", schema = "", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"CODI_TIPO_DOCU"})})
@XmlRootElement
@NamedQueries({
...
public class TipoDocu implements Serializable {
    ...
    @NotNull
    @Column(name = "CODI_TIPO_DOCU", nullable = false)
    private Long codiTipoDocu;
    @Size(max = 50)
    @Column(name = "NOMB_TIPO_DOCU", length = 50)
